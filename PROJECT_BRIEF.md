...
| 10 | Cover the names the user actually trades | 🟡 Partial-by-design | HC Svcs / MedTech / Pharma + all non-HC sectors covered; **biotech deliberately excluded in Phase 1** (see §4) |
